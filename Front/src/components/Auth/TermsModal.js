      ...
      <div className="termsModalContent" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="termsModalHeader">
          <h2 className="termsModalTitle">
            ...
            {currentTermInfo?.required && (
              <span className="requiredBadge">Required</span>
            )}
          </h2>
          <button 
            className="termsModalCloseButton" 
            onClick={onClose}
        ...
        <div className="termsModalFooter">
          <div className="currentAgreementStatus">
            {currentAgreement ? (
              <span className="agreedStatus">✅ Currently Agreed</span>
            ) : (
              <span className="notAgreedStatus">❌ Not Agreed</span>
            )}
          </div>

          <div className="termsModalActions">
            <button 
              className="termsModalCancelButton" 
              onClick={onClose}
            >
              Close
            </button>
            ...
            <button 
              className="termsModalAgreeButton" 
              onClick={handleAgree}
              disabled={loading}
            >
