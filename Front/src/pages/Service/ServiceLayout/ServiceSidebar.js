                        ...
                        <ul className="submenu">
                            {item.submenu.map((subItem) => (
                                <li key={subItem.path} className="submenuItem">
                                    <NavLink to={subItem.path} className={({ isActive }) => `submenuLink ${isActive ? 'submenuLinkActive' : ''}`} title={subItem.description}>
        ...
        <aside className="sidebar">
            ...
            <div className="sidebarHeader">
                <div className="stech-logo-box">
                    <img className="stech-logo" src={Logo} alt="STECH Logo" onClick={() => navigate('/service')} />
                </div>
