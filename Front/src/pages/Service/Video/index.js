        ...
        <div className="videoPlayerPage">
            <div className="videoContainer">
                ...
                <div className="floatingToolButtons">
                    ...
                    <button className="floatingToolBtn magicPencilBtn" onClick={() => setShowMagicPencil(true)} disabled={isPlaying || hasError || !selected || hasNoVideo} title="매직펜슬 (일시정지 상태에서만 사용 가능)">
                        <FaPencilAlt size={24} />
                    </button>
                </div>
